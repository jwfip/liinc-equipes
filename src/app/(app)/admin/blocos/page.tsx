  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-slate-500 text-sm mt-1">Apenas 1 bloco pode estar ativo por vez.</p>
      </div>

      <div className="card mb-6">
        <h2 className="font-display font-semibold text-sm mb-4 text-slate-600">Adicionar bloco</h2>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-200">
              <th className="text-left px-4 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Bloco</th>
